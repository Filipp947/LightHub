local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Filipp947/LightHub/refs/heads/main/library.luau"))()
...
if uis.TouchEnabled then
    ...
    button.Position = UDim2.new(0.5, -65, 0, -50)
