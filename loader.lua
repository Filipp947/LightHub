...
local Hub = "Light Hub"
local Hub_Script_ID = "53bfeeeca30266553e39e7e2a522336c"
local Discord_Invite = ""
local UI_Theme = "Dark"

local Linkvertise_Enabled = true
local Linkvertise_Link = "https://ads.luarmor.net/get_key?for=Light_Hub-hjhJoieYQkOu"
...
local function checkKey(input_key)
	...
	if status.code == "KEY_VALID" then
		...
		-- 99n
		loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/53bfeeeca30266553e39e7e2a522336c.lua"))()
		elseif game.gameId == 8316902627 then
		-- pvb
		loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/f020a6c36f648cab3f8cee0eebdd3930.lua"))()
		end
...
Tabs.Main:AddButton({
	Title = "Join Discord For help or a free permanent key",
	Callback = function()
